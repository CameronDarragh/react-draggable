...
export default class DraggableCore extends React.Component<DraggableCoreProps, DraggableCoreState> {
  ...
  static propTypes = {
    ...
    /**
     * `keepTouchEvents`, if true, stops the preventDefault that happens on touch events
     */
    keepTouchEvents: PropTypes.bool,
  ...
  handleDragStart: EventHandler<MouseTouchEvent> = (e) => {
    ...
    if (e.type === 'touchstart' && !this.props.keepTouchEvents) {
      e.preventDefault();
    }
